function outputstring(){
    ...
    if ((y==1)||(y==5)){
        z=["8:25","8:30","8:42","8:46","9:34","9:38","10:26","10:51","10:55","11:43","11:47","12:35","13:15","13:19","14:07","14:11","14:59","15:03","15:10"]
        for (var i in z){
    ...
    if ((y==2)||(y==3)){
        z=["8:25","8:30","8:42","8:46","9:27","9:31","10:12","10:37","10:41","11:22","11:26","12:07","12:11","12:51","13:31","13:35","14:15","14:19","14:59","15:03","15:10"]
        for (var i in z){
            k=new Date(z[i]+" "+parseInt(x.getMonth()+1)+"/"+x.getDate()+"/"+x.getFullYear());
            if (x.getTime()<k.getTime()){
                return [format(k.getTime()-x.getTime()),format(k.getTime()-x.getTime())]
    ...
    if (y==4){
        z=["8:25","8:30","8:42","8:46","9:30","9:34","10:18","10:43","10:47","11:30","11:34","12:17","12:21","12:51","13:31","13:35","14:15","14:19","14:59","15:03","15:10"]
        for (var i in z){
            k=new Date(z[i]+" "+parseInt(x.getMonth()+1)+"/"+x.getDate()+"/"+x.getFullYear());
            if (x.getTime()<k.getTime()){
                return [format(k.getTime()-x.getTime()),format(k.getTime()-x.getTime())]
